...
//        System.out.println(p);
        ...
        List<Product> place_prods = service.getProductByPlace("White Table");
        for(Product product : place_prods){
            System.out.println(product);
        }
        System.out.println("==============================================");
        System.out.println("Out of Warranty Products");
        List<Product> out_war_prods = service.getProductOutOfWarranty();
        for(Product product : out_war_prods){
            System.out.println(product);
        }
